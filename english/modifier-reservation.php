...
<body class="main">
            ...
            <div class="containered">
                            ...
                            <?php 
                                ...
                                if(isset($contentres)){
                                    ...
                                    ?>
                                     ...
                                     <div class="mb-3">
                         <label for="exampleInputEmail1" class="formlabel2">Please select a date :</label>
                         <input type="text"  name="date"  value="<?= $titreres; ?> " >    
                         </div>
                   

                         <div class="mb-3">
                <label for="exampleInputEmail1" class="formlabel2">Please select an hour :</label>
                ...
                <div class="mb-3">
                <label for="exampleInputEmail1" class="formlabel2">Please select a type of box :</label>
                    <select name="loge" id="selecthours">
                            
                            <option  name="rloge" value="Loge classique"><p>Classical box</p></option>
                            <option  name="rloge" value="Loge VIP"><p>VIP box</p></option>
                            <option  name="rloge" value="Loge premium">Premium Box </option>
                          ...
                          <div class="mb-3">
                              <label for="exampleInputEmail1" class="formlabel2">Name</label>
                          ...
                          <div class="mb-3">
                <label for="exampleInputEmail1" class="formlabel2">"Please select a team for these playoffs (home game for the chosen team):"</label>
