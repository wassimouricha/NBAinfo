...
<body class="main">
            ...
            <form class="form-container" method="POST"> <!-- ici j'ajoute la method HTTP post afin d'indiquer que je vais envoyer des informations -->
                ...
                <div class="input-field">
                        ...
                        <input type="text" placeholder="Lastname" name="rname">
                    </div>
                ...
                <div class="input-field">
                    ...
                    <label for="exampleInputEmail1" class="form-label">Please select a type of box :</label>
                    <div class="input-field">
                        <i class="fas fa-user"></i>
                    ...
                    <label for="exampleInputEmail1" class="form-label">Please select a team for these playoffs (home game for the chosen team):</label>
                    <div class="input-field">
                        <i class="fas fa-user"></i>
